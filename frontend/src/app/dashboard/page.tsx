      ...
      <main style={{ maxWidth: 1120, margin: '0 auto', padding: '40px 28px 100px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28, paddingTop: 20 }}>
          <div>
            ...
            <h1 style={{ fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: 900, letterSpacing: '-0.04em', color: 'var(--text-primary)', marginTop: 6, lineHeight: 1.05 }}>
              Stellar Asset Core
            </h1>
            <p style={{ fontSize: '0.75rem', fontWeight: 500, color: 'var(--text-secondary)', marginTop: 6 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8, paddingTop: 4 }}>
            ...
            <button
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 99, background: 'var(--text-primary)', color: 'var(--bg-void)', border: 'none', fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', cursor: 'pointer' }}
            >
              <RefreshCcw size={11} />
              Trigger Rebalance
            </button>
